...
//fuction
    ...
    func configurePageControll () {
        ...
        pageControl = UIPageControl (frame: CGRect(x: (view.frame.width - pageControllWidth)/2, y: safeHeight - pageControlHeight, width: pageControllWidth, height: pageControlHeight))
